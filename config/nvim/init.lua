...
-- Alternar renderizado Y ocultamiento de Neovim
...
end, { desc = "Toggle Markdown Render & Conceal" })
...
vim.pack.add({
	...
	"https://github.com/saeedvaziry/wal.nvim",
})
...
require("bufferline").setup({
	options = {
		mode = "buffers", -- Comportamiento de pestañas estilo VS Code
		offsets = {
			{
				filetype = "NvimTree",
				text = "Explorador",
...
local efm_config = {
	languages = {
		...
		c = { require("efmls-configs.linters.cpplint"), require("efmls-configs.formatters.clang_format") },
		cpp = { require("efmls-configs.linters.cpplint"), require("efmls-configs.formatters.clang_format") },
		...
		json = { require("efmls-configs.linters.eslint_d"), require("efmls-configs.formatters.fixjson") },
		jsonc = { require("efmls-configs.linters.eslint_d"), require("efmls-configs.formatters.fixjson") },
